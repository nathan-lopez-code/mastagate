            ...
            <div class="bg-white dark:bg-gray-800 overflow-hidden shadow-sm sm:rounded-lg">
                <div class="p-6 text-gray-900 dark:text-gray-100">
                    ...
                    <div class="overflow-x-auto relative shadow-md sm:rounded-lg mt-5" style="margin-top: 50px">
                        <h2 class="mt-5" >Liste de pack-services</h2>
                        <table class="w-full text-sm text-left text-gray-500 dark:text-gray-400">
                            <thead class="text-xs text-gray-700 uppercase bg-gray-50 dark:bg-gray-700 dark:text-gray-400">
                            <tr>
                                <th scope="col" class="py-3 px-6">nom pack</th>
                                <th scope="col" class="py-3 px-6">Descriptions</th>
                                <th scope="col" class="py-3 px-6 text-right">Avantage</th>
                            </tr>
                            </thead>
                            <tbody>
