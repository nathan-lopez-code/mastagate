                ...
                <div class="p-6 text-gray-900 dark:text-gray-100">
                    <form action="{{ route('dashboard.packs.store') }}" method="POST" enctype="multipart/form-data">
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-6 mb-6">
                            ...
                            <div class="form-group">
                                ...
                                <input type="number" step="0.01" min="0" class="form-control"
                                       id="price" name="price" placeholder="Laissez vide si 'Sur Devis'" value="{{ old('price') }}">
                                @error('price')
                                <div class="text-red-500 text-sm mt-1">{{ $message }}</div>
                                @enderror
                            </div>
                        ...
                        <div class="mb-6 form-group">
                            ...
                            <textarea name="description" id="description" class="form-control min-h-[100px]" placeholder="Décrivez en quelques lignes ce que comprend ce pack.">{{ old('description') }}</textarea>
                            @error('description')
                            <div class="text-red-500 text-sm mt-1">{{ $message }}</div>
                            @enderror
                        </div>
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-6 mb-6">
                            ...
                            <div class="flex flex-col justify-center">
                                ...
                                <div class="flex items-center form-group mb-4">
                                    ...
                                    <input id="is_quotation" name="is_quotation" type="checkbox" value="1" {{ old('is_quotation') ? 'checked' : '' }}
                                ...
                                <div class="flex items-center form-group mb-4">
                                    ...
                                    <input id="is_trending" name="is_trending" type="checkbox" value="1" {{ old('is_trending') ? 'checked' : '' }}
                                    class="h-4 w-4 text-indigo-600 border-gray-300 rounded focus:ring-indigo-500 dark:bg-gray-700 dark:border-gray-600 dark:focus:ring-indigo-600">
        ...
        document.addEventListener('DOMContentLoaded', function() {
            ...
            function togglePriceField() {
                if (isQuotationCheckbox.checked) {
                    ...
                    priceInput.placeholder = 'Ex: 99.99';
                }
            }
